...
public class NfeSaidaDao {
	
	public static void adicionarNFE(int codi_emp, int ide_nnf, Double vNF, String dEmi, String chNFe, String emit_cnpj, String emit_xnome, String dest_cnpj, String dest_xnome, String cStat, String isNotaDominio) {

		String sql = "insert into nfe(codi_emp, ide_nnf, vNF, dEmi, chNFe, emit_cnpj, emit_xnome, dest_cnpj, dest_xnome, cStat, isNotaDominio) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
